...
class _NewUserScreenState extends State<NewUserScreen> {
  ...
  Future<void> createUser(context, int role, {int retry = 0}) async {
    setState(() {
    ...
    if (response.statusCode == 200) {
      ...
      if (!success) {
        print('___HTTP WARNING CREATE USER');
      ...
      await Globals.refreshToken()
          .whenComplete(() => createUser(context, role, retry: 1));
    } else {
      print('___HTTP ERROR CREATE USER');
      showDialog(
          context: context,
    ...
    Provider.of<UsersProvider>(context, listen: false).getUsers(role);
  }
      ...
      child: Stack(children: [
        ...
        Scaffold(
          appBar: AppBar(
              ...
              centerTitle: true,
              title: Text(
                role == 4 ? 'Aggiungi utente' : 'Aggiungi Admin',
                          ...
                          child: Column(
                            children: [
                              ...
                              TextFormField(
                                ...
                                validator: (value) {
                                  if (!Globals.validatePassword(value!))
